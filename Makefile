...
LIBS = $(STDCPPLIBS) network shared translation ssl crypto
...
SYSTEM_INCLUDE_PATHS = \
	/boot/system/develop/headers/private/storage/ \
	/boot/system/develop/headers/private/input/ \
...
LINKER_FLAGS = /boot/system/servers/input_server
